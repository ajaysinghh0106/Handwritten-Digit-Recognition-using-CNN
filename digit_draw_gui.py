...
class DigitRecognizer:
    def __init__(self, root):
        ...
        tk.Button(btn_frame, text="Recognize", command=self.predict, bg="#4CAF50", fg="white").pack(side=tk.LEFT, padx=5)
        tk.Button(btn_frame, text="Clear", command=self.clear, bg="#f44336", fg="white").pack(side=tk.LEFT, padx=5)
